...
async function seedReminderRules(stats) {
  const items = [
    // QMAS 路径
    {
      ...
      nextRuleId: 'R_QMAS_PREP',
      isActive: true,
    },
    {
      ruleId: 'R_QMAS_PREP',
      ruleName: '材料准备启动 → 推荐信准备',
      eventName: 'material_prep_start',
      pathType: 'qmas',
      phase: 'preparation',
      triggerType: 'event',
      deadlineOffsetDays: 14,
      alertBeforeDays: [7, 3, 1],
      titleTemplate: '准备推荐信',
      descriptionTemplate: '推荐信是QMAS申请的关键材料，建议尽早联系推荐人。',
      chainParentId: 'R_QMAS_EVAL',
      isActive: true,
    },
    {
      ruleId: 'R_QMAS_SUBMIT',
      ruleName: '材料齐备 → 递交申请',
      eventName: 'materials_ready',
      pathType: 'qmas',
      phase: 'submission',
      triggerType: 'event',
      deadlineOffsetDays: 30,
      alertBeforeDays: [14, 7, 3, 1],
    ...
    // 通用里程碑提醒
    {
      ruleId: 'R_DOC_EXPIRY',
      ruleName: '证件到期提醒',
      eventName: 'doc_expiring',
      pathType: '*',
      phase: '*',
      triggerType: 'ocr_date',
    ...
    {
      ruleId: 'R_PR_ELIGIBLE',
      ruleName: '永居资格提醒',
      eventName: 'pr_eligible',
      pathType: '*',
      phase: 'pr',
      triggerType: 'event',
      deadlineOffsetDays: 0,
      alertBeforeDays: [365, 180, 90, 60, 30],
    ...
    },
    {
      ...
      alertBeforeDays: [60, 30, 14],
      titleTemplate: '已递交{pathName}申请{days}天',
      isActive: true,
    },
    // 定居阶段
    {
      ruleId: 'R_SETTLE_HKID',
      ruleName: '抵港后申领香港身份证',
      eventName: 'arrived_hk',
      pathType: '*',
      phase: 'settlement',
      triggerType: 'event',
      deadlineOffsetDays: 30,
      alertBeforeDays: [14, 7, 3],
      titleTemplate: '抵港后30天内申领香港身份证',
      isActive: true,
    },
    {
      ruleId: 'R_SETTLE_BANK',
      ruleName: '开立香港银行账户提醒',
      eventName: 'hkid_obtained',
      pathType: '*',
      phase: 'settlement',
      triggerType: 'event',
      deadlineOffsetDays: 30,
      alertBeforeDays: [14, 7],
      titleTemplate: '建议尽快开立香港银行账户',
      isActive: true,
    },
    // 续签
    {
      ruleId: 'R_RENEWAL_EMPLOYMENT',
      ruleName: '续签就业证明更新',
      eventName: 'renewal_period_start',
      pathType: '*',
      phase: 'renewal',
      triggerType: 'event',
      deadlineOffsetDays: 90,
      alertBeforeDays: [60, 30, 14, 7],
      titleTemplate: '请更新就业证明材料',
      isActive: true,
    },
    {
      ruleId: 'R_RENEWAL_TAX',
      ruleName: '续签税单准备',
      eventName: 'tax_season',
      pathType: '*',
      phase: 'renewal',
      triggerType: 'cron',
      deadlineOffsetDays: 90,
    ...
    // 永居
    {
      ...
      triggerType: 'event',
      deadlineOffsetDays: 0,
      alertBeforeDays: [180, 90, 60, 30],
      titleTemplate: '永居申请材料清单确认',
      chainParentId: 'R_PR_ELIGIBLE',
      isActive: true,
    },
    {
      ruleId: 'R_PR_ABSENCE',
...
async function seedArchivingRules(stats) {
  const items = [
    {
      ruleId: 'AR_QMAS_APPROVAL',
      pathType: 'qmas',
      stageName: '获批',
      triggerEvent: 'milestone_approval_qmas',
      archiveTitle: 'QMAS申请档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_TTPS_APPROVAL',
      pathType: 'ttps-a',
      stageName: '获批',
      triggerEvent: 'milestone_approval_ttps',
      archiveTitle: '高才通A类申请档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_TTPS_BC_APPROVAL',
      pathType: 'ttps-bc',
      stageName: '获批',
      triggerEvent: 'milestone_approval_ttps_bc',
      archiveTitle: '高才通B/C类申请档案',
      deletableWhenArchived: false,
    },
    {
    ...
    {
      ruleId: 'AR_IANG_APPROVAL',
      pathType: 'iang',
      stageName: '获批',
      triggerEvent: 'milestone_approval_iang',
      archiveTitle: 'IANG申请档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_CI_APPROVAL',
      pathType: 'ci',
      stageName: '获批',
      triggerEvent: 'milestone_approval_ci',
      archiveTitle: '资本投资者入境档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_QMAS_RENEWAL_V1',
      pathType: 'qmas',
      stageName: '第一次续签',
      triggerEvent: 'renewal_1_complete',
      archiveTitle: 'QMAS第一次续签档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_QMAS_RENEWAL_V2',
      pathType: 'qmas',
      stageName: '第二次续签',
      triggerEvent: 'renewal_2_complete',
      archiveTitle: 'QMAS第二次续签档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_TTPS_RENEWAL_V1',
      pathType: 'ttps-a',
      stageName: '第一次续签',
      triggerEvent: 'renewal_1_complete',
      archiveTitle: '高才通A类第一次续签档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_TTPS_RENEWAL_V2',
      pathType: 'ttps-a',
      stageName: '第二次续签',
      triggerEvent: 'renewal_2_complete',
      archiveTitle: '高才通A类第二次续签档案',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_IANG_RENEWAL',
      pathType: 'iang',
      stageName: '续签',
      triggerEvent: 'renewal_complete',
      archiveTitle: 'IANG续签档案',
      deletableWhenArchived: false,
    },
    {
    ...
    {
      ruleId: 'AR_PR_APPROVAL',
      pathType: '*',
      stageName: '永居获批',
      triggerEvent: 'pr_approved',
      archiveTitle: '永居申请档案 —— 永久保存',
      deletableWhenArchived: false,
    },
    {
      ruleId: 'AR_QMAS_ABANDONED',
      pathType: 'qmas',
      stageName: '放弃/被拒',
      triggerEvent: 'process_rejected',
      archiveTitle: 'QMAS申请档案（未获批）',
      deletableWhenArchived: true,
    },
    {
      ruleId: 'AR_TTPS_ABANDONED',
      pathType: 'ttps-a',
      stageName: '放弃/被拒',
      triggerEvent: 'process_rejected',
      archiveTitle: '高才通申请档案（未获批）',
      deletableWhenArchived: true,
    },
    {
      ruleId: 'AR_IANG_ABANDONED',
      pathType: 'iang',
      stageName: '放弃/被拒',
      triggerEvent: 'process_rejected',
      archiveTitle: 'IANG申请档案（未获批）',
      deletableWhenArchived: true,
    },
    {
      ruleId: 'AR_GENERAL_ARCHIVE',
      pathType: '*',
      stageName: '*',
      triggerEvent: 'manual_archive',
      archiveTitle: '手动归档',
      deletableWhenArchived: true,
    },
  ];
  ...
  const items = [
    {
      ...
      layers: {
        overview:
          '优秀人才入境计划（QMAS）2025年11月起改革，取消旧计分制，改为12项是/否评核准则，满足≥6项即可提交申请。',
        prerequisites:
          '12项评核准则（满足≥6项可申请）：A.年龄≤50岁 B1.合资格大学硕博 B2.STEM学科 C1.两种语言能力 C2.英文达标 D1.5年+经验 D2.3年+名企经验 D3.3年+创科/金融/贸易经验 D4.2年+国际经验 E.年收入≥100万港币 F1.拥有年盈利≥500万企业 F2.持上市公司≥10%股权',
      ...
      lastPolicyVersion: '2025-Q1',
      lastUpdatedAt: '2025-05-09',
    },
    {
      guideId: 'G_TTPS_A_OVERVIEW',
      nodeId: 'node_ttps_a',
      nodeName: '高才通A类',
      title: '高才通A类概览',
      category: 'overview',
      ...
      lastPolicyVersion: '2024-Q4',
      lastUpdatedAt: '2024-12-01',
    },
    {
      guideId: 'G_TTPS_BC_OVERVIEW',
      nodeId: 'node_ttps_bc',
      nodeName: '高才通B/C类',
      title: '高才通B/C类概览',
      category: 'overview',
      ...
      layers: {
        overview:
          'B类：获全球百强大学学士学位+申请前5年有3年工作经验。C类：获全球百强大学学士学位+工作经验少于3年（限额1万）。',
    ...
    {
      guideId: 'G_RECOMMENDATION',
      nodeId: 'node_recommendation',
      nodeName: '推荐信',
      title: '推荐信撰写指引',
      category: 'material',
      status: 'active',
...
async function seedMaterialStandards(stats) {
  const items = [
    {
      materialType: 'HK_PERMIT',
      materialName: '港澳通行证',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['HK_PERMIT', 'ID_CARD'],
      isRequired: true,
      originalRequirement: '扫描件（正反面）',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '10年（成人）',
      commonMistakes: ['只上传正面未上传反面', '有效期不足6个月'],
      obtainMethod: '户籍地公安局出入境管理处',
      obtainPeriod: '7-15工作日',
      status: 'active',
    },
    {
      ...
      materialName: '护照',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['PASSPORT'],
      isRequired: true,
      originalRequirement: '扫描件（个人信息页）',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '10年（成人）',
    ...
    },
    {
      ...
      materialName: '香港身份证',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['HK_ID'],
      isRequired: false,
      originalRequirement: '扫描件',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '永久有效',
      commonMistakes: [],
      obtainMethod: '入境处人事登记处（抵港后）',
      obtainPeriod: '约10个工作日',
      status: 'active',
    },
    {
      materialType: 'DEGREE',
      ...
      sourceDocTypes: ['DEGREE'],
      isRequired: true,
      originalRequirement: '扫描件',
      stampRequirement: '需有学校公章',
      translationRequirement: '非中英文版本需翻译公证',
      validityPeriod: '永久有效',
      commonMistakes: ['只上传学位证未上传成绩单', '海外学历未做认证'],
      obtainMethod: '毕业院校教务处',
      obtainPeriod: '视学校流程',
      status: 'active',
    },
    {
      materialType: 'BANK_STATEMENT',
      materialName: '银行流水/存款证明',
      applicablePaths: ['qmas', 'ttps-a', 'ci'],
      sourceDocTypes: ['BANK_STATEMENT', 'TAX_RETURN'],
      isRequired: true,
      originalRequirement: '银行盖章版本',
      stampRequirement: '需有银行公章',
      translationRequirement: '需中英文版本',
      validityPeriod: '开具后3个月内有效',
      commonMistakes: ['金额不足', '未翻译', '无银行盖章'],
      obtainMethod: '银行柜台或网银',
      obtainPeriod: '即日（柜台）或2-3工作日',
      status: 'active',
    },
    {
      materialType: 'EMPLOYMENT_CONTRACT',
      materialName: '工作证明/雇佣合约',
      applicablePaths: ['qmas', 'ttps-a', 'asmpt', 'iang'],
      sourceDocTypes: ['EMPLOYMENT_CONTRACT'],
      isRequired: true,
      originalRequirement: '扫描件',
      stampRequirement: '需有公司公章',
      translationRequirement: '非中英文版本需翻译',
      validityPeriod: '近3个月内出具',
    ...
    {
      materialType: 'TAX_RETURN',
      materialName: '税单/纳税证明',
      applicablePaths: ['qmas', 'ttps-a'],
      sourceDocTypes: ['TAX_RETURN'],
      isRequired: false,
      originalRequirement: '税务局出具版本',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '最近1-3个纳税年度',
      commonMistakes: ['只上传了代扣代缴凭证而非税务局证明'],
      obtainMethod: '税务局网站或办税服务厅',
      obtainPeriod: '即日（电子）或5-10工作日',
      status: 'active',
    },
    {
      materialType: 'POLICE_CLEARANCE',
      materialName: '无犯罪记录证明',
      applicablePaths: ['qmas', 'ci'],
      sourceDocTypes: ['POLICE_CLEARANCE'],
      isRequired: true,
      originalRequirement: '公安机关出具原件',
      stampRequirement: '需有公安机关公章',
      translationRequirement: '需中英文或翻译公证',
      validityPeriod: '出具后6个月内有效',
      commonMistakes: ['未翻译', '超过有效期', '申请地区不对'],
      obtainMethod: '户籍地派出所或公安局',
      obtainPeriod: '7-15工作日',
      status: 'active',
    },
    {
      ...
      materialName: '证件照',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['PHOTO'],
      isRequired: true,
      originalRequirement: '电子版（JPG/PNG）',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '6个月内拍摄',
      commonMistakes: ['背景非白色', '尺寸不符', '戴深色眼镜', '过度修图'],
      obtainMethod: '照相馆或自助拍照机',
      obtainPeriod: '即日',
      formatStandard: {
        photoSpec: {
          size: '55mm×45mm（头部34mm-39mm）',
          backgroundColor: '白色',
          headRatio: '面部占画面70-80%',
          recency: '6个月内',
        },
      },
      status: 'active',
    },
    {
      ...
      materialName: '住址证明',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['ADDRESS_PROOF', 'BANK_STATEMENT'],
      isRequired: true,
      originalRequirement: '近3个月内发出的账单/信件',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '发出后3个月内有效',
      commonMistakes: ['地址与申请表不一致', '超出3个月有效期'],
      obtainMethod: '电费/水费/银行账单',
      obtainPeriod: '即日（电子账单）',
      status: 'active',
    },
    {
      materialType: 'APPROVAL_LETTER',
      materialName: '批准信/签证标签',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['APPROVAL_LETTER'],
      isRequired: true,
      originalRequirement: '扫描件（含签证标签页）',
      stampRequirement: null,
      translationRequirement: null,
      validityPeriod: '按签证有效期',
      commonMistakes: ['未上传签证标签页', '未包含附带条件页'],
      obtainMethod: '入境处发出',
      obtainPeriod: '获批后约2-4周',
      status: 'active',
    },
    {
      materialType: 'MARRIAGE_CERT',
      materialName: '结婚证书',
      applicablePaths: ['qmas', 'ttps-a', 'ttps-bc', 'asmpt', 'iang', 'ci'],
      sourceDocTypes: ['MARRIAGE_CERT'],
      isRequired: false,
      originalRequirement: '扫描件',
      stampRequirement: '需有民政部门公章',
      translationRequirement: '非中英文版本需翻译公证',
      validityPeriod: '永久有效',
      commonMistakes: [],
      obtainMethod: '民政部门',
...
async function seedProcessTemplates(stats) {
  const items = [
    {
      templateId: 'qmas',
      templateName: '优才计划（QMAS）申请流程',
      applicablePaths: ['qmas'],
      totalStages: 6,
      version: '1.0.0',
      isActive: true,
      stages: [
          ...
          steps: [
            {
              ...
              stepName: '完成在线资格评估',
              order: 1,
              requiredMaterials: [{ materialType: 'HK_PERMIT', isOptional: false }],
            },
          ...
          steps: [
            {
              ...
              order: 1,
              requiredMaterials: [
                { materialType: 'HK_PERMIT', isOptional: false },
                { materialType: 'PASSPORT', isOptional: false },
              ],
            },
            {
              stepId: 'qmas_prep_2',
              stepName: '准备学历证明',
              order: 2,
              requiredMaterials: [{ materialType: 'DEGREE', isOptional: false }],
            },
            {
              stepId: 'qmas_prep_3',
              stepName: '准备工作证明',
              order: 3,
              requiredMaterials: [{ materialType: 'EMPLOYMENT_CONTRACT', isOptional: false }],
            },
            {
              stepId: 'qmas_prep_4',
              stepName: '准备资产证明',
              order: 4,
              requiredMaterials: [{ materialType: 'BANK_STATEMENT', isOptional: false }],
            },
        ...
        },
        {
          ...
          isMilestone: true,
          milestoneDocType: 'APPLICATION_FORM',
        ...
        },
        {
          ...
          isMilestone: false,
          steps: [{ stepId: 'qmas_wait_1', stepName: '关注甄选结果公布', order: 1, requiredMaterials: [] }],
        },
        {
          stageId: 'qmas_approval',
          stageName: '获批',
          order: 5,
          description: '收到批准通知，办理签证',
          isMilestone: true,
          milestoneDocType: 'APPROVAL_LETTER',
          ocrValidationRule: { docTypeDetected: 'APPROVAL_LETTER' },
          steps: [
            {
              stepId: 'qmas_approval_1',
              stepName: '查收批准信',
              order: 1,
              requiredMaterials: [{ materialType: 'APPROVAL_LETTER', isOptional: false }],
            },
            {
              stepId: 'qmas_approval_2',
              stepName: '办理港澳通行证签注',
              order: 2,
              requiredMaterials: [{ materialType: 'HK_PERMIT', isOptional: false }],
            },
        ...
        },
        {
          ...
          steps: [
            {
              stepId: 'qmas_arrival_1',
              stepName: '预约办理香港身份证',
              order: 1,
              requiredMaterials: [{ materialType: 'HK_ID', isOptional: false }],
            },
    ...
    {
      templateId: 'ttps-a',
      templateName: '高才通A类申请流程',
      applicablePaths: ['ttps-a'],
      totalStages: 4,
      version: '1.0.0',
      isActive: true,
      stages: [
          ...
          steps: [
            {
              ...
              order: 1,
              requiredMaterials: [
                { materialType: 'TAX_RETURN', isOptional: false },
                { materialType: 'BANK_STATEMENT', isOptional: false },
              ],
            },
          ],
        },
        ...
        {
          stageId: 'ttpsa_submit',
          stageName: '递交申请',
          order: 3,
          description: '在线递交高才通申请',
          isMilestone: true,
          milestoneDocType: 'APPLICATION_FORM',
          steps: [{ stepId: 'ttpsa_submit_1', stepName: '在线递交', order: 1, requiredMaterials: [] }],
        },
        {
          stageId: 'ttpsa_approval',
          stageName: '获批',
          order: 4,
    ...
    {
      templateId: 'iang',
      templateName: 'IANG签证申请流程',
      applicablePaths: ['iang'],
      totalStages: 3,
      version: '1.0.0',
      isActive: true,
      stages: [
        ...
        },
        {
          ...
          steps: [
            {
              stepId: 'iang_submit_1',
              stepName: '在线递交IANG申请',
              order: 1,
              requiredMaterials: [
                { materialType: 'DEGREE', isOptional: false },
                { materialType: 'HK_PERMIT', isOptional: false },
              ],
            },
          ],
        },
        {
          ...
          steps: [
            {
              stepId: 'iang_approval_1',
              stepName: '领取IANG签证标签',
              order: 1,
              requiredMaterials: [{ materialType: 'APPROVAL_LETTER', isOptional: false }],
            },
            {
              stepId: 'iang_approval_2',
              stepName: '办理香港身份证',
              order: 2,
              requiredMaterials: [{ materialType: 'HK_ID', isOptional: false }],
            },
...
async function seedProducts(stats) {
  const items = [
    {
      productId: 'precheck_basic',
      name: '资格预检（基础版）',
      price: 0,
      category: 'service',
      description: '自动材料匹配 + 基础风险点',
      unit: '分',
      isActive: true,
    },
    {
      productId: 'precheck_pro',
      name: '资格预检（专业版）',
      price: 9900,
      category: 'service',
      description: '基础版 + 人工复核 + 详细报告',
      unit: '分',
      isActive: true,
    },
    {
      productId: 'consult_30min',
      name: '30分钟一对一咨询',
      price: 29900,
      category: 'consultation',
      description: '线上视频/语音咨询',
      unit: '分',
      isActive: true,
    },
  ];
...
async function seedSimulatedAccounts(stats) {
  const items = [
    {
      accountId: 'SIM-QMAS-01',
      accountName: '张先生（优才申请人 · 金融行业）',
      attributes: {
        path: 'qmas',
        phase: 'preparation',
        industry: '金融',
        experienceYears: 10,
        incomeRange: '100-250万',
        educationLevel: '硕士',
        languageSkill: '中英',
        familyStatus: '已婚有子女',
      },
    ...
    {
      accountId: 'SIM-TTPSA-01',
      accountName: '李女士（高才通A类 · 科技行业）',
      attributes: {
        path: 'ttps-a',
        phase: 'preparation',
        industry: '科技',
    ...
    {
      accountId: 'SIM-IANG-01',
      accountName: '王同学（IANG申请人 · 应届硕士）',
      attributes: {
        path: 'iang',
        phase: 'evaluation',
        industry: '教育',
    ...
    {
      accountId: 'SIM-RENEWAL-01',
      accountName: '陈先生（高才通续签 · 金融行业）',
      attributes: {
        path: 'ttps-a',
        phase: 'renewal',
        industry: '金融',
