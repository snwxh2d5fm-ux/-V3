...
module.exports = [
  ...
  },
  {
    ...
    "tips": [
      "每年3月31日前做规划(购买医保/做慈善/供MPF)",
      "税率比较：累进(2-17%)vs标准(15%)→取较低者"
    ],
    "renewalEvidence": {
      "produces": false
    },
    ...
    "steps": [
      {
        "seq": 1,
        "title": "选择公司类型",
        "content": "私人有限公司(Limited)=最常用，股东责任有限。注册时可选择1人公司（自雇最简）或多人公司（合伙）。无限公司不推荐——个人承担无限责任。",
        "type": "info"
      },
      {
        "seq": 2,
        "title": "准备注册材料",
        "content": "公司名称（中英文任选，查册确保不重名）/ 注册资本（默认HK$1万，无需实缴）/ 董事+股东身份证明（通行证/护照副本+地址证明）/ 公司秘书（必须委任，可用秘书公司约$1,000-3,000/年）/ 注册地址（可用商务中心$200-500/月）",
        "type": "action"
      },
      {
        "seq": 3,
        "title": "线上注册(CR eFiling)",
        "content": "登入公司注册处eCR(eportal.cr.gov.hk)→填表NNC1→上传材料→缴费(电子提交HK$1,545)→1-5工作天获批→获发BR(商业登记证)+CI(公司注册证书)",
        "type": "action"
      },
      {
        "seq": 4,
        "title": "注册后30天内",
        "content": "①开立公司银行户口(汇丰/中银商业户口，1-2周审批) ②商业登记证续期(每年HK$2,150) ③刻公司印章(圆章+签名章，约$100-300) ④如实际运营:投保雇员补偿保险(强制)",
        "type": "checklist"
      }
    ],
    "requiredItems": [
    ...
    "steps": [
      {
        "seq": 1,
        "title": "自雇人士MPF义务",
        "content": "自雇人士（包括公司董事给自己发薪）必须登记MPF。月入>=HK$7,100须供款5%（上限HK$1,500）。即使月入<$7,100也须登记但免供款。逾期登记最高罚款HK$5,000+欠款20%附加费。",
        "type": "info"
      },
      {
        "seq": 2,
        "title": "雇主MPF开户",
        "content": "选择MPF受托人（汇丰/中银/宏利/AIA等）→填写雇主申请表→提交公司BR+CI副本→开设雇主MPF户口→为雇员（包括自己）登记参加强积金计划。雇主额外供款5%（共10%入雇员账户）。",
        "type": "action"
      },
      {
        "seq": 3,
        "title": "每月供款流程",
        "content": "每月10日前提交供款→计算雇员有关入息（上限$30,000/月）→雇主+雇员各5%→2025年起取消对冲机制→积金易eMPF平台统一管理（2024年6月启用）",
        "type": "info"
      }
    ],
    "requiredItems": [
    ...
    "steps": [
      {
        "seq": 1,
        "title": "周年申报(NAR1)",
        "content": "每周年向公司注册处递交NAR1表格→更新董事/股东/秘书资料→费用HK$105（电子提交）→逾期42天内罚HK$870→逾期超9个月最高罚HK$3,480",
        "type": "action"
      },
      {
        "seq": 2,
        "title": "利得税报税",
        "content": "税务局每年4月发出BIR51报税表→1个月内递交→附审计报告+利得税计算表。首年可获12个月延期。税率：首200万利润8.25%，超出部分16.5%。",
        "type": "action"
      },
      {
        "seq": 3,
        "title": "商业登记续期与审计",
        "content": "BR每年续期(HK$2,150/年)→过期续期追加罚款。所有有限公司必须每年聘请执业会计师做审计(费用约$5,000-20,000视营业额)。小型公司(收入<$200万)可做简化审计。",
        "type": "info"
      },
      {
        "seq": 4,
        "title": "续签自雇材料包",
        "content": "入境处自雇续签核心六件套：①有效BR+CI ②经审计的财务报告 ③利得税评税通知书 ④办公室租约(或商务中心合约) ⑤MPF雇主供款记录 ⑥公司银行月结单。建议每季度整理一次。",
        "type": "info"
      }
    ],
    "requiredItems": [
    ...
    "steps": [
      {
        "seq": 1,
        "title": "给自己发薪的税务逻辑",
        "content": "公司给自己(董事)发月薪→公司代扣MPF→公司向税务局申报IR56B→个人收到BIR60报税→提交个人薪俸税申报→获评税通知书(税单)。月薪建议>=HK$30,000以确保续签时'在港有合理收入'",
        "type": "info"
      },
      {
        "seq": 2,
        "title": "个人报税流程",
        "content": "每年5月收到BIR60绿色信封→1个月内线上(eTax)或邮寄递交→10-11月收到评税通知书→翌年1月缴第一期(75%)→4月缴第二期(25%)。eTax可延期至2个月。",
        "type": "action"
      },
      {
        "seq": 3,
        "title": "自雇人士扣税清单",
        "content": "MPF供款$18,000(强制)+$60,000(自愿)/ 住宅租金$100,000 / 自愿医保$8,000/人 / 居所贷款利息$100,000 / 进修开支$100,000 / 慈善捐款<=应评税入息35%",
        "type": "info"
      }
    ],
    "requiredItems": [
