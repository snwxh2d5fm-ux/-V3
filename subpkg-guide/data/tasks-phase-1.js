    ...
    steps: [
      {
        ...
        title: '了解四大电讯商',
        content:
          '3HK（$148/月，100GB+中港澳6GB，北上常客首选）；CMHK中国移动（$149/月，100GB+中澳2GB，条软简单免行政费）；CSL（$138-168/月，送Perplexity Pro AI服务）；SmarTone（$179/月，送$1,000手机礼券+爆芒保）。',
        type: 'info',
      },
      {
        seq: 2,
        title: '选择套餐并上台',
        content:
          '携同香港身份证+地址证明前往电讯商门市。如未有香港身份证，部分电讯商接受护照+入境记录。上台通常需签24-36个月合约。',
        type: 'action',
      },
      {
        seq: 3,
    ...
    steps: [
      {
        ...
        title: '下载并注册',
        content:
          'App Store/Google Play搜索「AlipayHK」下载。使用香港手机号注册。如已有内地支付宝，需重新注册香港版（两个独立App）。',
        type: 'action',
      },
      {
        seq: 2,
      ...
      },
      {
        ...
        title: '绑定缴费账户',
        content:
          '搜寻「缴费专区」→选择机构（中电/港灯/煤气/水务署/差饷）→输入账单编号→开启自动付款。覆盖近500个缴费商户。',
        type: 'action',
      },
    ],
    ...
    steps: [
      {
        ...
        title: '出发前准备',
        content:
          '带齐文件：护照/港澳通行证+签证标签页+入境小白条+预约确认（截图或打印）。如已在关卡0完成了预约，直接按预约时间前往。',
        type: 'checklist',
      },
      {
        seq: 2,
        title: '现场办理',
        content:
          '按预约时间到达指定入境处办事处→取号→拍照→打指模→领取「申请身份证收据」（临时身份证）。办理过程约30-45分钟。',
        type: 'action',
      },
      {
        seq: 3,
    ...
    steps: [
      {
        ...
        title: '出行三件套',
        content:
          'MTR Mobile（港铁路线/票价/班次/都会票购买）、Google Maps（香港公共交通规划准确度很高）、Uber/滴滴出行（Call车用）。',
        type: 'action',
      },
      {
        seq: 2,
