    ...
    steps: [
      {
        ...
        title: '整理必备文件',
        content:
          '护照/港澳通行证（有效期≥6个月）+ 签证标签页 + 入境小白条（过关时获发，务必保留）。建议准备一个透明文件袋统一收纳。',
        type: 'checklist',
      },
      {
        seq: 2,
      ...
      },
      {
        ...
        title: '准备现金',
        content:
          '建议携带HK$5,000-10,000现金。香港很多地方（街市/茶餐厅/的士）只收现金或八达通。在内地银行提前兑换，汇率更优。',
        type: 'action',
      },
    ],
    ...
    steps: [
      {
        ...
        title: '网上预约',
        content:
          '登入入境处网上预约系统（gov.hk/icbooking），选择「申领香港智能身份证」。填写姓名、证件号码、出生日期。',
        type: 'action',
      },
      {
        seq: 2,
        title: '选择办理日期——这是关键一步',
        content:
          '先定身份证预约日期，再据此安排过关日。最佳策略：预约在过关当天或次日，激活签证+办身份证一趟搞定。湾仔总部最满，九龙（长沙湾/观塘）或新界（火炭/元朗/屯门）更容易约到。每天上午9点释放新名额。',
        type: 'action',
      },
      {
        seq: 3,
        title: '根据预约日期反推过关日',
        content:
          '确认预约日期后，再安排过关激活签证的日期（建议提前1天或当天）。过关日确定后，依次预订交通、住宿、准备过关文件包。',
        type: 'action',
      },
      {
        seq: 4,
    ...
    steps: [
      {
        ...
        title: '交通出行类',
        content:
          'MTR Mobile（港铁路线/票价/班次）、Citybus/九巴App（巴士路线/到站时间）、Uber/滴滴出行（叫车）。高德地图在香港可用但精度不如Google Maps。',
        type: 'action',
      },
      {
        seq: 2,
        title: '支付与生活类',
        content:
          'AlipayHK（香港支付宝）、八达通App（管理八达通卡）、PayMe（汇丰旗下的电子钱包）。内地支付宝/微信支付在香港部分商户可用但不全面。',
        type: 'action',
      },
      {
        seq: 3,
        title: '政府与医疗类',
        content:
          'HA Go（医管局一站式医疗App）、智方便iAM Smart（政府数码身份认证）、My SmartPLAY（康文署运动场地预约）。',
        type: 'action',
      },
      {
        seq: 4,
    ...
    steps: [
      {
        ...
        title: '确定抵达口岸',
        content:
          '机场：香港国际机场（最常用）。高铁：西九龙站（内地高铁直达）。陆路口岸：深圳湾/罗湖/落马洲/港珠澳大桥。',
        type: 'info',
      },
      {
        seq: 2,
        title: '规划从口岸到住处的交通',
        content:
          '机场→市区：机场快线（24分钟到中环，HK$115）/ 机场巴士（较便宜但较慢，HK$20-40）/ 的士（约HK$250-400）。高铁西九龙→市区：步行至柯士甸/九龙站转港铁。',
        type: 'action',
      },
      {
        seq: 3,
        title: '准备抵达当日的通讯方案',
        content:
          '机场可以买八达通（MTR客务中心/7-Eleven）。抵达后第一件事——买电话卡或连机场WiFi。机场有免费WiFi（限时30分钟）。',
        type: 'info',
      },
    ],
