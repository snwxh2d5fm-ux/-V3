...
module.exports = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: '选择银行并预约',
        content:
          '首选中银香港（门槛低/内地身份友好/支持内地地址证明），次选汇丰One（网点多/全球转账），备选ZA Bank（纯线上辅助）',
        type: 'info',
      },
      {
        seq: 3,
        title: '亲临分行办理',
        content:
          '按预约时间到达，非永久居民不可豁免地址证明，开户用途需明确（工资入账+日常消费+跨境汇款），柜台约30-45min',
        type: 'action',
      },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: '亲临诊所完成首次线下登记',
        content:
          '携HK身份证+地址证明前往任一公立诊所/医院，成人自助，小童家长代携港澳通行证+有效签证，⚠️建议健康时尽早登记',
        type: 'action',
      },
      {
        seq: 3,
    ...
    steps: [
      {
        ...
        title: '选择申请方式',
        content:
          '方式一：经“智方便+”网上申请（即时生效，可凭智能身份证借书）；方式二：网上申请电子账户（仅电子资源）；方式三：亲临图书馆',
        type: 'info',
      },
      {
        seq: 2,
