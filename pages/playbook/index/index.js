...
Page({
  ...
  getBuiltInGuides() {
    return [
      { id: 'g1', title: '香港优才12项评分标准详解（2025新版）', knowledge_domain: 'QMAS', topics: ['优才','评分'], summary: '逐条拆解12项评分标准...', usefulCount: 156, imageUrl: '' },
      { id: 'g2', title: '高才通A类申请全流程：从收入证明到获批', knowledge_domain: 'TTPS', topics: ['高才通','A类'], summary: '年收入250万港币证明材料清单...', usefulCount: 89, imageUrl: '' },
      { id: 'g3', title: 'IANG签证转永居：7年时间线完整攻略', knowledge_domain: 'IANG', topics: ['IANG','永居'], summary: '从学生签证到永居的每一步...', usefulCount: 203, imageUrl: '' },
      { id: 'g4', title: '香港租房避坑指南：签约前必查的5件事', knowledge_domain: 'LIFE', topics: ['租房','生活'], summary: '签约前务必核查...', usefulCount: 312, imageUrl: '' },
      { id: 'g5', title: '香港银行开户实战：中银汇丰渣打对比', knowledge_domain: 'LIFE', topics: ['银行','开户'], summary: '三间银行开户要求对比...', usefulCount: 178, imageUrl: '' },
      { id: 'g6', title: '专才自雇申请全流程：自己聘自己', knowledge_domain: 'ASMTP', topics: ['专才','自雇'], summary: '自雇专才的材料清单...', usefulCount: 67, imageUrl: '' },
      { id: 'g7', title: '香港薪俸税报税省钱攻略', knowledge_domain: 'TAX', topics: ['税务','报税'], summary: '合法减税的N种方式...', usefulCount: 145, imageUrl: '' },
      { id: 'g8', title: '香港国际学校申请时间线与面试准备', knowledge_domain: 'EDUCATION', topics: ['教育','国际学校'], summary: '热门国际学校申请节点...', usefulCount: 92, imageUrl: '' }
    ];
  },
