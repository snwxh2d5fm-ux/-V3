...
Component({
  properties: {
    show: {
      ...
      value: false,
      observer: function (n) {
        if (n) this.setData({ _visible: true, _loading: false, _error: '' });
      },
    },
    ...
    handleLogin: function () {
      ...
      wx.login({
        success: function (loginRes) {
          ...
          wx.cloud
            .callFunction({ name: 'user-auth', data: { action: 'login', code: loginRes.code } })
            .then(function (res) {
              ...
              if (result.code === 0 && result.token) {
                ...
                app.saveSession({
                  ...
                  membershipLevel: result.membershipLevel || 'free',
