...
const SLOT_GUIDES = {
  id_card: {
    ...
    piiFields: ['姓名', '身份证号', '出生日期', '地址'],
    specimen: '人像面+国徽面·无反光·圆角完整',
    wfFields: [
  ...
  degree: {
    ...
    piiFields: ['姓名', '证书编号', '出生日期'],
    specimen: '学位证正面·钢印+校长签名',
    wfFields: [
  ...
  hk_permit: {
    ...
    piiFields: ['姓名', '证件号', '出生日期', '有效期'],
    specimen: '通行证正面个人信息页+背面签注页',
    wfFields: [
  ...
  passport: {
    ...
    piiFields: ['姓名', '护照号', '出生日期', '出生地点'],
    specimen: '护照第2页资料页·牡丹花防伪',
    wfFields: [
  ...
  hk_id: {
    ...
    piiFields: ['姓名', '身份证号', '出生日期'],
    specimen: '香港身份证正面·照片左置·彩色',
    wfFields: [
  ...
  household: {
    ...
    piiFields: ['姓名', '身份证号', '住址', '籍贯'],
    specimen: '首页+户主页+本人页·印章清晰',
    wfFields: [
  ...
  marriage: {
    ...
    piiFields: ['双方姓名', '证件号', '登记日期', '出生日期'],
    specimen: '双页展开·钢印骑缝·红印清晰',
    wfFields: [
  ...
  birth_cert: {
    ...
    piiFields: ['婴儿姓名', '父母姓名', '身份证号', '出生日期'],
    specimen: '正页+副页·红色印章·条形码清晰',
    wfFields: [
  ...
  work: {
    ...
    piiFields: ['姓名', '身份证号', '薪资', '公司名'],
    specimen: '公司抬头纸+公章+签字',
    wfFields: [
  ...
  language_cert: {
    ...
    title: '语言成绩材料标准',
    wfTitle: '语言能力证明',
    items: ['官方成绩单原件拍摄（IELTS/TOEFL/HSK等）', '考生姓名、考试日期、分数清晰', '证书编号完整可见'],
    piiFields: ['姓名', '考生编号'],
    specimen: '语言成绩单原件',
    wfFields: [
  ...
  admission_letter: {
    ...
    title: '录取通知书材料标准',
    wfTitle: '录取通知书',
    items: ['学校官方录取通知书原件', '含学校抬头、学生姓名、录取专业', '入学日期和学制清晰', '学校印章/签发人签字'],
    piiFields: ['姓名', '申请编号'],
    specimen: '学校抬头·官方印章',
    wfFields: [
      { label: '学校名称 (抬头)', width: 'full', pii: false },
  ...
  exchange_agreement: {
    ...
    title: '交换协议材料标准',
    wfTitle: '交换/交流项目协议',
    items: ['双方学校签署的交换协议原件', '含交换期间、学分互认条款', '双方学校印章清晰'],
    piiFields: ['姓名', '学号'],
    specimen: '双方学校盖章',
    wfFields: [
  ...
  parttime_enrollment: {
    ...
    title: '兼读在读证明标准',
    wfTitle: '兼读课程在读证明',
    items: ['学校出具的在读证明原件', '含学校抬头、学生姓名、攻读学位', '注明兼读制（Part-time）', '学校印章清晰'],
    piiFields: ['姓名', '学号'],
    specimen: '学校抬头·注明兼读制',
    wfFields: [
      { label: '学校名称 (抬头)', width: 'full', pii: false },
  ...
  emp_letter: {
    ...
    title: '雇主聘用书材料标准',
    wfTitle: '雇主聘用书 / 雇佣合约',
    items: ['公司抬头纸原件拍摄', '含职位、入职日期、薪资、工作职责', '雇主签字+公司盖章', '注明雇佣性质（全职/合约）'],
    piiFields: ['姓名', '身份证号', '薪资'],
    specimen: '公司抬头纸·公章+签字',
    wfFields: [
      { label: '公司名称 (抬头)', width: 'full', pii: false },
      { label: '员工姓名', width: 'short', pii: true },
  ...
  recommendation: {
    ...
    piiFields: ['申请人姓名', '推荐人姓名'],
    specimen: '推荐人签字·含联系方式',
    wfFields: [
  ...
  org_chart: {
    ...
    title: '组织架构图标准',
    wfTitle: '公司组织架构图',
    items: ['公司官方组织架构图', '标明申请人所属部门及层级', '如有公司印章更佳', '中英文版本均可'],
    piiFields: ['申请人姓名', '部门'],
    specimen: '公司组织架构图',
    wfFields: [
  ...
  tech_achievement: {
    ...
    title: '科技成果/专利证明标准',
    wfTitle: '科技成果 / 专利证书',
    items: ['专利证书/科技奖励证书原件', '专利权人/获奖人姓名清晰', '专利号/证书编号完整', '授权日期和有效期'],
    piiFields: ['专利人姓名', '专利号'],
    specimen: '专利证书·授权日期',
    wfFields: [
  ...
  tax_record: {
    ...
    title: '税单材料标准',
    wfTitle: '个人所得税完税证明',
    items: ['税务机关出具的完税证明', '最近1-3个纳税年度', '含纳税人姓名和身份证号', '税务印章清晰'],
    piiFields: ['姓名', '身份证号'],
    specimen: '税务局出具·完税证明',
    wfFields: [
...
const MORE_GUIDES = {
  investment_proof: {
    ...
    title: '投资证明标准',
    wfTitle: '投资资产证明',
    items: ['证券公司/银行出具的投资资产证明', '含账户名、资产类型、估值', '最近日期的资产报告', '金融机构印章'],
    piiFields: ['账户名', '账号'],
    specimen: '金融机构出具·近期估值',
    wfFields: [
  ...
  asset_proof: {
    icon: '🏠',
    title: '资产证明标准',
    wfTitle: '个人资产证明 (存款/房产)',
    items: ['银行存款证明或房产证', '含持有人姓名、资产价值', '银行/房管局官方文件', '存款证明需冻结期≥3个月'],
    piiFields: ['持有人', '账号/房产证号'],
    specimen: '银行/房管局官方文件',
    wfFields: [
  ...
  retirement_fund: {
    ...
    title: '退休金证明标准',
    wfTitle: '退休金/强积金证明',
    items: ['MPF强积金或社保退休金证明', '含姓名、账户信息、累积金额', '最近日期的账户报告'],
    piiFields: ['姓名', '账户号'],
    specimen: '强积金/社保·近期报告',
    wfFields: [
  ...
  pension_proof: {
    ...
    title: '养老金证明标准',
    wfTitle: '养老金/社保领取证明',
    items: ['社保局出具的养老金领取证明', '含姓名、领取金额、发放记录', '最近6-12个月发放记录'],
    piiFields: ['姓名', '身份证号'],
    specimen: '社保局出具·近期记录',
    wfFields: [
  ...
  funding_proof: {
    ...
    title: '资金来源说明标准',
    wfTitle: '资金来源说明',
    items: ['说明资产来源的书面文件', '如有银行转账记录一并提供', '注明金额、来源途径、用途', '本人签字+日期'],
    piiFields: ['姓名', '账户号'],
    specimen: '书面说明·本人签字',
    wfFields: [
  ...
  no_crime: {
    ...
    title: '无犯罪记录证明标准',
    wfTitle: '无犯罪记录证明',
    items: ['户籍所在地公安局/派出所出具', '含姓名、身份证号、无犯罪记录声明', '有效期一般为6个月', '公安机关印章清晰'],
    piiFields: ['姓名', '身份证号'],
    specimen: '公安机关出具·6个月有效',
    wfFields: [
  ...
  sponsor_id: {
    ...
    title: '保证人身份证标准',
    wfTitle: '保证人身份证明文件',
    items: ['保证人身份证/护照原件拍摄', '姓名、证件号、有效期清晰', '如非香港居民需同时提供签证页'],
    piiFields: ['保证人姓名', '证件号'],
    specimen: '保证人身份证·正面',
    wfFields: [
  ...
  sponsor_income: {
    ...
    title: '保证人收入证明标准',
    wfTitle: '保证人收入证明',
    items: ['保证人最近6-12个月收入证明', '含姓名、收入金额、时间段', '公司抬头+盖章或税务机关出具'],
    piiFields: ['保证人姓名', '收入金额'],
    specimen: '保证人收入证明',
    wfFields: [
      { label: '出具机构 (抬头)', width: 'full', pii: false },
      { label: '保证人姓名', width: 'short', pii: true },
  ...
  sponsor_employment: {
    ...
    title: '保证人在职证明标准',
    wfTitle: '保证人在职证明',
    items: ['保证人雇主出具的在职证明', '含职位、在职期间、工作性质', '公司抬头纸+盖章+签字'],
    piiFields: ['保证人姓名', '公司名'],
    specimen: '公司抬头·公章+签字',
    wfFields: [
      { label: '公司名称 (抬头)', width: 'full', pii: false },
  ...
  guardian_id: {
    ...
    title: '监护人身份证标准',
    wfTitle: '监护人身份证明文件',
    items: ['监护人身份证/护照原件拍摄', '姓名、证件号、有效期清晰', '需可证明监护关系（如户口本/公证书）'],
    piiFields: ['监护人姓名', '证件号'],
    specimen: '监护人身份证·正面',
    wfFields: [
  ...
  guardian_consent: {
    ...
    piiFields: ['监护人姓名', '未成年人姓名'],
    specimen: '监护人签字·含联系方式',
    wfFields: [
      { label: '监护人姓名', width: 'short', pii: true },
  ...
  guardian_income: {
    ...
    title: '监护人收入证明标准',
    wfTitle: '监护人经济能力证明',
    items: ['监护人最近6-12个月收入/资产证明', '含姓名、收入金额、时间段', '可提供薪资证明+银行流水'],
    piiFields: ['监护人姓名', '收入金额'],
    specimen: '收入证明+银行流水',
    wfFields: [
      { label: '出具机构 (抬头)', width: 'full', pii: false },
      { label: '监护人姓名', width: 'short', pii: true },
  ...
  approval: {
    icon: '✅',
    title: '获批通知/e-Visa材料标准',
    wfTitle: '入境许可通知书 / e-Visa',
    items: [
      '入境处发出的正式通知原件',
      '申请编号、批准日期、签证类型清晰',
      'e-Visa可拍摄打印版或手机截图',
    ...
    piiFields: ['姓名', '申请编号', '签证类型'],
    specimen: '获批通知书/e-Visa PDF',
    wfFields: [
...
const KEY_ALIASES = {
  degree_cert: 'degree',
  emp_proof: 'work',
  recommendation: 'emp_letter',
  income_proof: 'income_250w',
  bank_statement: 'bank',
  income_250w: 'income_250w',
  tax_record: 'income_250w',
  plan_statement: 'plan_statement',
  no_crime: 'no_crime',
  birth_cert: 'birth_cert',
  marriage_cert: 'marriage',
  household: 'household',
  ...
  tech_achievement: 'work',
  salary_proof: 'income_250w',
  sponsor_id: 'id_card',
  sponsor_income: 'income_250w',
  sponsor_employment: 'work',
  guardian_id: 'id_card',
  guardian_consent: 'approval',
  guardian_income: 'income_250w',
  exchange_agreement: 'exchange_agreement',
  parttime_enrollment: 'parttime_enrollment',
  degree_auth: 'degree_auth',
  hk_permit: 'hk_permit',
  passport: 'passport',
  hk_id: 'hk_id',
  approval: 'approval',
  visa_label: 'approval',
  funding_proof: 'bank',
  investment_proof: 'income_250w',
  asset_proof: 'income_250w',
  retirement_fund: 'income_250w',
  pension_proof: 'income_250w',
  photo: 'id_card',
};

const ALL_GUIDES = {};
Object.keys(SLOT_GUIDES).forEach(function (k) {
  ALL_GUIDES[k] = SLOT_GUIDES[k];
});
Object.keys(MORE_GUIDES).forEach(function (k) {
  ALL_GUIDES[k] = MORE_GUIDES[k];
});

function getSlotGuide(slotKey, docName) {
  const name = (docName || '').toLowerCase();
  const resolvedKey = KEY_ALIASES[slotKey] || slotKey;
  if (resolvedKey && ALL_GUIDES[resolvedKey]) return ALL_GUIDES[resolvedKey];
  for (const key in ALL_GUIDES) {
...
const FREE_DOC_GUIDES = {
  ...
  hk_permit: {
    icon: '🛂',
    wfTitle: '往来港澳通行证',
    items: ['背景：深色桌面', '信息页：个人信息+签注页完整', '边距：四角完整，勿裁切'],
    piiFields: ['姓名', '证件号', '有效期'],
    specimen: '个人信息页·无反光',
    showPhoto: true,
    showSeal: false,
    wfFields: [
  ...
  passport: {
    icon: '🛂',
    wfTitle: '中华人民共和国护照',
    items: ['背景：深色桌面', '信息页：含照片个人信息页', '边距：护照四边完整'],
    piiFields: ['姓名', '护照号', '出生日期'],
    specimen: '个人信息页·无反光',
    showPhoto: true,
    showSeal: false,
    wfFields: [
  ...
  hk_id: {
    icon: '🆔',
    wfTitle: '香港永久性居民身份证',
    items: ['背景：深色桌面', '正面：芯片面朝上', '边距：四角完整'],
    piiFields: ['姓名', '身份证号'],
    specimen: '正面·芯片可见',
    showPhoto: true,
    showSeal: false,
  ...
  household: {
    icon: '📖',
    wfTitle: '居民户口簿',
    items: ['背景：深色桌面', '内容：户主页+本人页', '边距：四角完整'],
    piiFields: ['姓名', '身份证号', '住址'],
    specimen: '户主页+本人页',
    showPhoto: false,
    showSeal: true,
    wfFields: [
  ...
  marriage: {
    icon: '💍',
    wfTitle: '中华人民共和国结婚证',
    items: ['背景：深色桌面', '内容：双页展开', '要求：印章+照片清晰'],
    piiFields: ['双方姓名', '证件号'],
    specimen: '双页展开·印章清晰',
    showPhoto: true,
    showSeal: true,
  ...
  birth_cert: {
    icon: '👶',
    wfTitle: '出生医学证明',
    items: ['背景：深色桌面', '内容：正面完整', '要求：编号+印章清晰'],
    piiFields: ['婴儿姓名', '出生日期'],
    specimen: '正面·无折叠',
    showPhoto: false,
    showSeal: true,
  ...
  degree: {
    icon: '🎓',
    wfTitle: '学位证书',
    items: ['背景：深色桌面', '内容：证书正面完整', '要求：证书编号+印章清晰'],
    piiFields: ['姓名', '证书编号'],
    specimen: '正面·印章清晰',
    showPhoto: true,
    showSeal: true,
  ...
  plan_statement: {
    icon: '📝',
    wfTitle: '赴港计划书 (文字)',
    items: ['此材料为文字撰写，非文件上传', '建议800-1500字', '内容：来港目的+职业规划+对港贡献'],
    piiFields: ['姓名'],
    specimen: '文字撰写·800-1500字',
    showPhoto: false,
    showSeal: false,
  ...
  approval: {
    icon: '✅',
    wfTitle: '获批通知书',
    items: ['背景：深色桌面', '内容：通知完整页面', '要求：申请编号+日期清晰'],
    piiFields: ['姓名', '申请编号'],
    specimen: '获批原件',
    showPhoto: false,
    showSeal: true,
...
function getFreeDocGuide(docType) {
  return FREE_DOC_GUIDES[docType] || null;
}
...
const SLOT_CATEGORY_MAP = {
  ...
  hk_id: 'identity',
  photo: 'identity',
  degree_cert: 'education',
  transcript: 'education',
  degree_auth: 'education',
  language_cert: 'education',
  admission_letter: 'education',
  exchange_agreement: 'education',
  parttime_enrollment: 'education',
  emp_letter: 'work',
  emp_proof: 'work',
  reference_letter: 'work',
  recommendation: 'work',
  salary_proof: 'work',
  org_chart: 'work',
  emp_3y: 'work',
  ...
  income_250w: 'assets',
  income_proof: 'assets',
  investment_proof: 'assets',
  asset_proof: 'assets',
  retirement_fund: 'assets',
  pension_proof: 'assets',
  funding_proof: 'assets',
  visa_label: 'approved',
  approval: 'approved',
  plan_statement: 'approved',
  student_visa: 'approved',
  hk_visa: 'approved',
  no_crime: 'approved',
  marriage_cert: 'identity',
  birth_cert: 'identity',
  household: 'identity',
  sponsor_id: 'identity',
  sponsor_income: 'assets',
  sponsor_employment: 'work',
  guardian_id: 'identity',
  guardian_consent: 'approved',
  guardian_income: 'assets',
};

function slotToCategory(slotKey) {
  return SLOT_CATEGORY_MAP[slotKey] || '';
}
...
const BAR_ALIASES = {
  ...
  emp_letter: 'work',
  emp_3y: 'work',
  salary_proof: 'id_card',
  sponsor_id: 'id_card',
  guardian_id: 'id_card',
  visa_label: 'approval',
  student_visa: 'approval',
  company_docs: 'id_card',
  tech_achievement: 'work',
  reference_letter: 'work',
  recommendation: 'work',
  sponsor_income: 'id_card',
  sponsor_employment: 'work',
  guardian_income: 'id_card',
  guardian_consent: 'approval',
  investment_proof: 'id_card',
  asset_proof: 'id_card',
  retirement_fund: 'id_card',
  pension_proof: 'id_card',
  funding_proof: 'bank',
  no_crime: 'work',
};

function getPrivacyBars(docType, slotKey) {
  const resolvedBarKey = BAR_ALIASES[slotKey] || docType;
...
module.exports = {
  getSlotGuide: getSlotGuide,
  getFreeDocGuide: getFreeDocGuide,
  slotToCategory: slotToCategory,
  getPrivacyBars: getPrivacyBars,
};
