    ...
    categories: [
      {
        ...
        slots: [
          ...
          },
          {
            ...
            docIcon: '📷',
            requirement: 'required',
            description: '白底50×40mm',
            maxCount: 1,
          },
          {
            slotKey: 'marriage_cert',
            docName: '结婚证(配偶)',
            docIcon: '💍',
            requirement: 'required',
            description: '如配偶随行',
      ...
      },
      {
        ...
        slots: [
          ...
          },
          {
            ...
            docIcon: '✅',
            requirement: 'required',
            description: '学信网/留服认证',
            maxCount: 1,
          },
          {
            slotKey: 'language_cert',
            docName: '语言成绩',
            docIcon: '🗣️',
            requirement: 'recommended',
            description: '雅思7+/托福94+',
            maxCount: 1,
          },
        ],
      },
        ...
        slots: [
          {
            ...
            docIcon: '📋',
            requirement: 'required',
            description: '含职位+起止日期+职责',
            maxCount: -1,
          },
          {
            slotKey: 'recommendation',
            docName: '推荐信',
            docIcon: '✉️',
            requirement: 'required',
            description: '建议2-3封',
      ...
      },
      {
        ...
        slots: [
          {
            slotKey: 'income_proof',
            docName: '收入证明',
            docIcon: '💵',
            requirement: 'required',
            description: '过去一年≥100万HKD',
            maxCount: 1,
          },
          {
      ...
      },
      {
        ...
        slots: [
          {
            slotKey: 'plan_statement',
            docName: '赴港计划书',
            docIcon: '📝',
            requirement: 'required',
            description: '500字以内，说明赴港发展计划',
            maxCount: 1,
          },
          {
            slotKey: 'no_crime',
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          {
            slotKey: 'income_250w',
            docName: '年收入证明(≥250万HKD)',
            docIcon: '💵',
            requirement: 'required',
            description: '完税证明+银行流水+雇主证明',
            maxCount: 3,
          },
          {
            slotKey: 'company_docs',
            docName: '公司证明文件',
            docIcon: '🏢',
            requirement: 'required',
            description: '营业执照+股权证明(如自雇)',
            maxCount: 2,
          },
        ],
      },
        ...
        slots: [
          {
            ...
            docIcon: '🏦',
            requirement: 'required',
            description: '覆盖首年学费+生活费',
            maxCount: 1,
          },
          {
            slotKey: 'funding_proof',
            docName: '资金来源说明',
            docIcon: '💵',
            requirement: 'recommended',
            description: '奖学金/家庭资助证明',
            maxCount: 1,
          },
        ],
      },
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          ...
          {
            slotKey: 'parttime_enrollment',
            docName: '兼读在读证明',
            docIcon: '📖',
            requirement: 'required',
            description: '兼读制课程注册证明',
            maxCount: 1,
          },
        ],
      },
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          ...
          {
            slotKey: 'tech_achievement',
            docName: '科技成果/专利',
            docIcon: '🏆',
            requirement: 'required',
            description: '专利/论文/项目成果',
            maxCount: 3,
          },
          { slotKey: 'recommendation', docName: '推荐信', docIcon: '✉️', requirement: 'recommended', maxCount: 2 },
        ],
  ...
  any_cies_application: {
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          {
            slotKey: 'investment_proof',
            docName: '净资产证明(≥3000万HKD)',
            docIcon: '📊',
            requirement: 'required',
            description: '银行/审计出具资产证明',
            maxCount: 1,
          },
          {
            slotKey: 'bank_statement',
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          ...
          {
            slotKey: 'sponsor_income',
            docName: '保证人收入证明',
            docIcon: '💵',
            requirement: 'required',
            description: '证明可负担受养人生活',
            maxCount: 1,
          },
          {
            slotKey: 'sponsor_employment',
            docName: '保证人在职证明',
            docIcon: '📋',
            requirement: 'required',
            maxCount: 1,
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          ...
          {
            slotKey: 'exchange_agreement',
            docName: '交换协议/批准函',
            docIcon: '📋',
            requirement: 'required',
            description: '本校批准+对方接收',
            maxCount: 1,
          },
  ...
  any_retirement_application: {
    ...
    categories: [
      ...
      },
      {
        ...
        slots: [
          {
            slotKey: 'retirement_fund',
            docName: '退休金/养老金证明',
            docIcon: '🏦',
            requirement: 'required',
            description: '证明稳定退休收入',
            maxCount: 1,
          },
          {
            slotKey: 'bank_statement',
  ...
  default_application: {
    ...
    categories: [
      ...
      },
      {
        ...
        categoryName: '学历证明',
        categoryIcon: '🎓',
        slots: [{ slotKey: 'degree_cert', docName: '学位证书', docIcon: '📜', requirement: 'required', maxCount: 1 }],
      },
    ],
  },
};
...
function matchTemplate(status, path, mode) {
  ...
  const pathModeKey = 'any_' + path + '_' + mode;
  if (INDEX_TEMPLATES[pathModeKey]) return INDEX_TEMPLATES[pathModeKey];

  // 3) 其他已知状态前缀匹配同一路径 (例: 用户submitted后仍能命中unapplied_qmas模板)
  const KNOWN_STATUSES = ['unapplied', 'submitted', 'approved', 'permanent', 'renewal', 'skipped'];
  for (let i = 0; i < KNOWN_STATUSES.length; i++) {
    const altKey = KNOWN_STATUSES[i] + '_' + path + '_' + mode;
 ...
 */
const SELF_ONLY_CATEGORIES = ['work', 'assets', 'approved', 'employment', 'financial', 'application'];
...
function computeSlotStates(template, uploadedDocs, ownerType) {
  return template.categories.map(function (cat) {
    ...
    const effectiveOwner = SELF_ONLY_CATEGORIES.indexOf(cat.categoryKey) !== -1 ? 'self' : ownerType;

    // 按所属人过滤身份证明中的结婚证/出生证明卡槽
    let filteredSlots = cat.slots;
    ...
    const slots = filteredSlots.map(function (slot) {
      const uploaded = uploadedDocs.filter(function (d) {
      ...
      // 检查过期
      const hasExpiring = uploaded.some(function (d) {
      ...
      return {
        ...
        uploadedDocs: uploaded.map(function (d) {
          const backName = slot.slotKey === 'hk_permit' ? '签注面' : slot.slotKey === 'passport' ? '信息页' : '国徽面';
          const label = d.photoSide === 'front' ? '人像面' : d.photoSide === 'back' ? backName : '';
          d.sideLabel = label;
          return d;
        }),
        uploadedCount: count,
    ...
    const required = slots.filter(function (s) {
      return s.requirement === 'required';
    });
    const filled = required.filter(function (s) {
      return s.fillStatus === 'filled';
    }).length;
