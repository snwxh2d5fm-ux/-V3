...
module.exports = [
  ...
  },
  {
    ...
    requiredItems: ['子女出生证明及身份证明', '父母HK身份证/签证', '住址证明', '入学申请表+报名费'],
    pitfalls: [
  ...
  },
  {
    ...
    requiredItems: ['子女出生证明及身份证明', '父母HK身份证/签证', '住址证明', '入息证明（申请资助用——家庭月入审查）'],
    pitfalls: [
  ...
  },
  {
    ...
    requiredItems: ['幼稚园概览（chsc.hk）可按区域筛选全部注册幼稚园——需与关卡3找房向导联动选区域'],
    pitfalls: [
  ...
  },
  {
    ...
    steps: [
      {
        ...
        title: '对比表',
        content:
          '官立(免费/粤语/派位/极难插)/资助(免费/粤语/80%学校/难)/直资($20k-130k/年/中英/自主招/中等)/私立($100k-300k/年/英文/灵活/较易)/国际($100k-300k/年/英文/海外升学/较易)',
        type: 'info',
      },
      {
        seq: 2,
    ...
    requiredItems: ['子女出生证明及身份证明', '住址证明（官立/资助按校网）', '成绩单/在学证明', '课外活动/获奖证明'],
    pitfalls: [
    ...
    steps: [
      {
        ...
        title: '8项材料清单',
        content:
          '出生证明+近2-3年成绩表+证书/奖状(不超10页)+父母身份证副本+住址证明+回邮信封+申请费$50-200+学生近照2-4张',
        type: 'info',
      },
      {
        seq: 2,
  ...
  },
  {
    ...
    requiredItems: ['持续8年的在学证明/成绩单档案', '各阶段学校申请表', '课外活动/比赛证明'],
    pitfalls: [
