...
module.exports = [
  {
    ...
    applicableTo: {
      ...
      skipIfExisting: ['driving-license'],
    },
    steps: [
      {
        seq: 1,
      ...
      },
      {
        ...
        title: '网上预约',
        content:
          '运输署全面网上预约（2026年3月起取消即日筹），每天550名额，每工作日下午5时更新未来4周名额，九龙/观塘/沙田专责处理内地驾照',
        type: 'action',
      },
      {
        seq: 3,
    ...
    steps: [
      {
        ...
        title: '港铁',
        content:
          '下载MTR Mobile→了解路线/票价/班次→都会票（$460/40程，平均$11.5/程）→早晨折扣（平日7:15-8:15出闸75折）→全月通',
        type: 'info',
      },
      {
        seq: 2,
    ...
    steps: [
      {
        ...
        title: '寻找群组',
        content:
          'Facebook搜索[区名]跑团/[区名]行山群，Meetup.com搜索“Hong Kong hiking/board games/language exchange”，教会/佛堂/清真寺',
        type: 'info',
      },
      {
        seq: 2,
    ...
    steps: [
      {
        ...
        title: '了解报税时间',
        content:
          '5月第一工作日税务局发BIR60（绿色信封）→6-7月提交→10-11月收评税通知→翌年1月缴第一期（75%）→4月缴第二期（25%）',
        type: 'info',
      },
      {
        seq: 2,
