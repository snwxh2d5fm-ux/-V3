...
module.exports = [
    ...
    steps: [
      {
        ...
        title: '签署正式租约',
        content:
          '确认条款：一年死约一年生约/租金是否全包/家电清单/维修责任/宠物/免租期，支付两按一上（2月按金+1月上期）',
        type: 'action',
      },
      {
        seq: 2,
    ...
    steps: [
      {
        ...
        title: '三大供应商对比',
        content:
          '网上行Netvigator（$118-138私楼，送Now TV+Perplexity Pro）/香港宽频HKBN（$88-149，送Global SIM+Disney+）/有线宽频i-Cable（$68-88全港最平）',
        type: 'info',
      },
      {
        seq: 2,
    ...
    steps: [
      {
        ...
        title: '必需品分级清单',
        content:
          '第一优先（马上要）：床褥+枕头+被子/冰箱/洗衣机/煮食炉/热水炉；第二优先（1周内）：饭桌+椅/衣柜/窗帘；第三优先（慢慢添）：沙发/电视/书桌',
        type: 'info',
      },
      {
        seq: 2,
    ...
    steps: [
      {
        ...
        title: '回答三个问题',
        content:
          '预算(5档:$10k-15k/$15k-25k/$25k-40k/$40k-60k/$60k+)/工作在哪区(港岛/九龙/新界/远程)/有无学龄儿童(有/无)',
        type: 'info',
      },
      {
        seq: 2,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: '购房十步流程',
        content:
          '财务评估→预批按揭→搵楼睇楼→查册出价→签临约(细订3-5%)→正式申请按揭→签正约(14天，大订10%)→银行放款(约3月)→收楼验楼',
        type: 'info',
      },
      {
        seq: 3,
    ...
    steps: [
      {
        ...
        title: '从价印花税阶梯',
        content:
          '$300万以下$100/$300-450万1.5%/$450-600万2.25%/$600-900万3%/$900-2000万3.75%/$2000万-1亿4.25%/$1亿+6.5%',
        type: 'info',
      },
      {
        seq: 2,
  ...
  },
  {
    ...
    requiredItems: ['HK身份证/护照', '临时买卖合约（临约）', '细订收据（楼价3-5%）', '土地查册结果（土地注册处报告）'],
    pitfalls: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: '签约前最后确认',
        content:
          '确认租约条款：死约/生约、免租期(通常3-7天)、维修责任、宠物条款\n确认已打厘印（法律效力）\n确认业主已递交CR109表格\n抄录水/电/煤气表读数\n拍照留底：全屋各角落+已有损坏处',
        type: 'checklist',
      },
    ],
    officialLinks: [
