...
var QMAS_PHASE1 = [
  ...
  { nodeId: 'QE-02', nodeName: '确认是否满足≥6项准则', actionDescription: '12项是/否评核准则中满足≥6项即可提交申请', timeLogic: { type: 'event_driven', anchorField: 'QE01Completed', offsetDays: 0, estimatedDuration: null }, triggerMaterials: [], prerequisites: ['QE-01'], riskLevel: 'critical', reminderSchedule: { milestones: [7, 3], frequency: 'once' } },
