...
module.exports = [
  ...
  },
  {
    ...
    reminders: [{ label: '回乡证到期预警，提前预约换领', offset_days: 0, alerts: [180, 90, 60, 30, 14, 7] }],
  },
  {
  ...
  },
  {
    ...
    reminders: [{ label: '香港身份证到期，预约换领', offset_days: 0, alerts: [90, 60, 30, 14, 7] }],
  },
  ...
  },
  {
    ...
    reminders: [{ label: '季度住址证明更新检查（保留最近3个月账单）', offset_days: 0, alerts: [14, 7, 3] }],
  },
  ...
  },
  {
    ...
    reminders: [{ label: '暂缴税缴纳到期', offset_days: 0, alerts: [30, 14, 7, 3] }],
  },
  ...
  },
  {
    ...
    reminders: [{ label: 'MPF年度权益报表查收（续签/永居必备）', offset_days: 0, alerts: [30, 14, 7] }],
  },
  ...
  // ── 银行 ──
  {
    ...
    reminders: [{ label: '抵港后开立香港银行账户', offset_days: 14, alerts: [14, 7, 3] }],
  },
  {
    rule_id: 'R_BANK_STATEMENT',
    trigger: { event: 'bank_statement_needed', date_field: 'statementDate' },
    reminders: [{ label: '银行月结单保存(续签/永居地址证明用)', offset_days: 0, alerts: [30, 14, 7] }],
  },
  ...
  // ── 家庭 ──
  {
    ...
    reminders: [{ label: '受养人签证到期 — 跟随主申续签', offset_days: 0, alerts: [180, 90, 60, 30, 14, 7] }],
  },
  {
  ...
  // ── 驾照 ──
  {
    ...
    trigger: { event: 'hk_arrival', date_field: 'arrivalDate' },
    reminders: [{ label: '内地驾照免试换领香港驾照（抵港后）', offset_days: 90, alerts: [90, 60, 30] }],
  },
  ...
  },
  {
    ...
    reminders: [{ label: 'TechTAS申请递交', offset_days: 0, alerts: [30, 14, 7, 3] }],
  },
  ...
  },
  {
    ...
    reminders: [{ label: 'CIES申请递交(投资→审批→获批)', offset_days: 0, alerts: [30, 14, 7] }],
  },
  {
  ...
  },
  {
    ...
    reminders: [{ label: '受养人满7年 — 可独立申请永居', offset_days: 0, alerts: [365, 180, 90] }],
  },
  {
    rule_id: 'R_DEPENDENT_SPOUSE_WORK',
    trigger: { event: 'dependent_visa_issued', date_field: 'issueDate' },
    reminders: [{ label: '配偶受养人可在港工作(主申非学生签)', offset_days: 0, alerts: [90, 60, 30] }],
  },
  ...
  // --- IANG续签: 2+3+3模式，审批2-3周(入境处官网原文:首次24个月, 续签3-3年) ---
  {
    ...
    reminders: [
      ...
      {
        label: 'IANG续签递交窗口(到期前3个月内，入境处建议最少提前6周，审批2-3周)',
        offset_days: -90,
        alerts: [90, 60, 42, 28, 14, 7],
      },
    ],
  },
  {
  ...
  // --- 专才/GEP续签: 2-3-3模式，审批4-6周，需雇主担保 ---
  {
    ...
    reminders: [
      {
        label: '专才续签准备启动(3+3+2模式: 首次3年→3年→2年, 2022.12.28起)',
        offset_days: -180,
        alerts: [180, 120, 90],
      },
      { label: '专才续签—联系雇主准备ID990B担保表格(需内部审批)', offset_days: -90, alerts: [90, 60, 45] },
      {
        label: '专才续签递交窗口(到期前3个月内，入境处建议提前6周，审批2-3周)',
        offset_days: -90,
        alerts: [90, 60, 42, 28, 14, 7],
      },
  ...
  },
  {
    ...
    reminders: [{ label: '⚠️ 已逾期逗留 — 立即联系入境处', offset_days: 0, alerts: [0] }],
  },
  ...
  },
  {
    ...
    trigger: { event: 'hk_arrival', date_field: 'arrivalDate' },
    reminders: [{ label: '办理八达通卡(成人/学生)', offset_days: 0, alerts: [14, 7, 3] }],
  },
  {
  ...
  },
  {
    ...
    reminders: [{ label: '办理公共图书馆借书证(免费)', offset_days: 30, alerts: [90, 60] }],
  },
  {
    rule_id: 'R_SETTLE_COMMUNITY',
    trigger: { event: 'hk_settled', date_field: 'settleDate' },
    reminders: [{ label: '加入社区组织/同乡会(永居居住证明用)', offset_days: 90, alerts: [180, 90] }],
  },
  ...
  },
  {
    ...
    reminders: [{ label: '办公室租约到期 — 续约或搬迁', offset_days: 0, alerts: [90, 60, 30, 14] }],
  },
  {
  ...
  },
  {
    ...
    reminders: [{ label: '非中/英文文件需认证翻译', offset_days: 0, alerts: [30, 14, 7] }],
  },
...

  {
    ...
    trigger: { event: 'dependent_visa_issued', date_field: 'issueDate' },
    reminders: [{ label: '配偶可在港合法工作(非学生签受养人)', offset_days: 0, alerts: [90, 60, 30] }],
  },
  {
  ...
  },
  {
    ...
    trigger: { event: 'maintaining_residency', date_field: 'startDate' },
    reminders: [{ label: '保持在港就医记录(续签居住证明用)', offset_days: 0, alerts: [365, 180] }],
  },
  {
  ...
  },
  {
    ...
    reminders: [{ label: '证件照拍摄(白底50mm×40mm，6个月内)', offset_days: 0, alerts: [14, 7, 3] }],
  },
...

  {
    ...
    reminders: [{ label: '确认入境限制政策 — 可能影响签证激活', offset_days: 0, alerts: [30, 14, 7] }],
  },
  {
    rule_id: 'R_SPECIAL_VISA_EXTENSION',
    trigger: { event: 'force_majeure', date_field: 'eventDate' },
    reminders: [{ label: '特殊情况 — 向入境处申请签证延期', offset_days: 0, alerts: [30, 14, 7] }],
  },
...

  {
    ...
    reminders: [{ label: '学生合法兼职(2024起无限时)', offset_days: 0, alerts: [60, 30] }],
  },
  {
    rule_id: 'R_STUDENT_INTERNSHIP',
    trigger: { event: 'semester_break', date_field: 'breakDate' },
    reminders: [{ label: '寒暑假实习申请', offset_days: 0, alerts: [60, 30, 14] }],
  },
];
