...
module.exports = [
  ...
  // 关卡6: 自雇创业专项 (4项)
  {
    ...
    steps: [
      ...
      { seq: 2, title: "准备注册材料", content: "公司名称（中英文任选，查册确保不重名）/ 注册资本（默认HK$1万，无需实缴）/ 董事+股东身份证明（通行证/护照副本+地址证明）/ 公司秘书（必须委任，可用秘书公司约$1,000-3,000/年）/ 注册地址（可用商务中心$200-500/月）", type: "action" },
      { seq: 3, title: "线上注册(CR eFiling)", content: "登入公司注册处eCR(eportal.cr.gov.hk)→填表NNC1→上传材料→缴费(电子提交HK$1,545)→1-5工作天获批→获发BR(商业登记证)+CI(公司注册证书)", type: "action" },
      { seq: 4, title: "注册后30天内", content: "①开立公司银行户口(汇丰/中银商业户口，1-2周审批) ②商业登记证续期(每年HK$2,150) ③刻公司印章(圆章+签名章，约$100-300) ④如实际运营:投保雇员补偿保险(强制)", type: "checklist" }
    ],
    requiredItems: ["身份证明文件", "地址证明", "HK$1,545注册费"],
    officialLinks: [{ label: "公司注册处eCR", url: "https://eportal.cr.gov.hk" }, { label: "商业登记署", url: "https://www.ird.gov.hk" }],
    tips: ["1人自雇公司=给自己发工资+供MPF=最灵活的续签模式", "注册地址可用商务中心(月租$200-500)，不需要实体办公室", "秘书公司年费$1,000-3,000", "公司银行户口比个人户口审批更严，预留2-4周"],
    pitfalls: ["公司注册不等于可以立即发工资——必须先开公司银行户口", "商业登记证每年必须续期，逾期罚款$300+", "无限公司不等于简化——个人对公司全部债务承担无限责任"],
    renewalEvidence: { produces: true, docType: "商业登记证+公司注册证书", docCategory: "employment", collectMethod: "photo", isRequiredForRenewal: true, renewalTip: "BR+CI是自雇续签的核心证明。续签时入境处会核查公司真实运营状态。" },
    reminderTrigger: null, documentLink: null, aiChatContext: null
  },
  {
    ...
    steps: [
      ...
      { seq: 2, title: "雇主MPF开户", content: "选择MPF受托人（汇丰/中银/宏利/AIA等）→填写雇主申请表→提交公司BR+CI副本→开设雇主MPF户口→为雇员（包括自己）登记参加强积金计划。雇主额外供款5%（共10%入雇员账户）。", type: "action" },
      { seq: 3, title: "每月供款流程", content: "每月10日前提交供款→计算雇员有关入息（上限$30,000/月）→雇主+雇员各5%→2025年起取消对冲机制→积金易eMPF平台统一管理（2024年6月启用）", type: "info" }
    ],
    requiredItems: ["公司BR+CI", "银行户口", "雇员名单（含自己）"],
    officialLinks: [{ label: "积金局", url: "https://www.mpfa.org.hk" }, { label: "积金易eMPF", url: "https://www.empf.org.hk" }],
    tips: ["自雇人士供款可扣税（每年上限$18,000）", "月入<$7,100可申请豁免供款但须登记", "选择MPF计划时比较管理费和基金表现", "2025年5月起取消对冲——遣散费不可再用MPF雇主供款抵扣"],
    pitfalls: ["雇主不供款=刑事罪行，最高罚款$350,000+监禁3年", "即使只有自己一个员工也必须设立雇主MPF户口", "受雇和自雇双重身份须分别供款"],
    renewalEvidence: { produces: true, docType: "强积金雇主供款记录", docCategory: "employment", collectMethod: "photo", isRequiredForRenewal: true, renewalTip: "雇主MPF供款记录是自雇续签的'两址两单'核心材料之一。" },
    reminderTrigger: null, documentLink: null, aiChatContext: null
  },
  {
    ...
    steps: [
      ...
      { seq: 2, title: "利得税报税", content: "税务局每年4月发出BIR51报税表→1个月内递交→附审计报告+利得税计算表。首年可获12个月延期。税率：首200万利润8.25%，超出部分16.5%。", type: "action" },
      { seq: 3, title: "商业登记续期与审计", content: "BR每年续期(HK$2,150/年)→过期续期追加罚款。所有有限公司必须每年聘请执业会计师做审计(费用约$5,000-20,000视营业额)。小型公司(收入<$200万)可做简化审计。", type: "info" },
      { seq: 4, title: "续签自雇材料包", content: "入境处自雇续签核心六件套：①有效BR+CI ②经审计的财务报告 ③利得税评税通知书 ④办公室租约(或商务中心合约) ⑤MPF雇主供款记录 ⑥公司银行月结单。建议每季度整理一次。", type: "info" }
    ],
    requiredItems: ["公司BR+CI", "银行月结单", "业务单据"],
    officialLinks: [{ label: "公司注册处", url: "https://www.cr.gov.hk" }, { label: "税务局利得税", url: "https://www.ird.gov.hk" }],
    tips: ["聘用执业会计师费用可计入公司支出抵税", "简化审计门槛：收入<$200万可用中小企财务报告准则", "公司文件保存7年(公司法规定)", "即使公司无利润也要做审计和报税"],
    pitfalls: ["零申报不等于不审计——香港所有有限公司都必须审计", "逾期年审罚款递增快——NAR1逾期9个月罚$3,480", "续签时公司不能是空壳——必须证明真实业务运营"],
    renewalEvidence: { produces: true, docType: "审计报告+利得税评税通知", docCategory: "employment", collectMethod: "photo", isRequiredForRenewal: true, renewalTip: "审计报告+利得税评税通知书是自雇续签的'两址两单'核心税单证明。" },
    reminderTrigger: null, documentLink: null, aiChatContext: null
  },
  {
    ...
    steps: [
      ...
      { seq: 2, title: "个人报税流程", content: "每年5月收到BIR60绿色信封→1个月内线上(eTax)或邮寄递交→10-11月收到评税通知书→翌年1月缴第一期(75%)→4月缴第二期(25%)。eTax可延期至2个月。", type: "action" },
      { seq: 3, title: "自雇人士扣税清单", content: "MPF供款$18,000(强制)+$60,000(自愿)/ 住宅租金$100,000 / 自愿医保$8,000/人 / 居所贷款利息$100,000 / 进修开支$100,000 / 慈善捐款<=应评税入息35%", type: "info" }
    ],
    requiredItems: ["公司BR+CI", "个人银行月结单", "MPF供款记录"],
    officialLinks: [{ label: "税务局eTax", url: "https://www.gov.hk/etax" }],
    tips: ["给自己发薪时月薪不要太低——续签时入境处会看'在港有合理收入'", "薪俸税+利得税=双税单=续签最强'在港贡献'证明", "建议月薪HK$30,000-50,000(覆盖MPF上限+显示正常收入水平)"],
    pitfalls: ["公司亏损不是你个人不报税的理由——个人薪俸税和公司利得税是分开的", "给自己发薪时必须有实际银行转账记录(不能是账面数字)", "不要频繁调整自己工资——入境处会质疑公司运营稳定性"],
    renewalEvidence: { produces: true, docType: "个人评税通知书", docCategory: "employment", collectMethod: "photo", isRequiredForRenewal: true, renewalTip: "个人薪俸税评税通知书+利得税评税通知书=自雇续签双税单黄金组合。" },
    reminderTrigger: null, documentLink: null, aiChatContext: null
  },
