...
Page({
  ...
  loadPlans: function () {
    ...
    wx.cloud
      ...
      .then(function (res) {
        const plans = (res.result && res.result.data) || [];
        // 价格单位分→元（用于展示）
        const displayPlans = plans.map(function (p) {
          // 年付比月付省多少（百分比）
          const savingsPercent = Math.round(Math.abs((1 - (p.priceMonthly * 12) / p.priceYearly) * 100));
          return {
            planId: p.planId,
            planName: p.planName,
            level: p.level,
      ...
      .catch(function (e) {
        ...
        const fallbackPlans = [
          ...
          },
          {
            ...
            priceMonthly: 29990,
            priceYearly: 299900,
            priceMonthlyYuan: '299.90',
            priceYearlyYuan: '2,999',
            savingsPercent: 20,
            features: [
              '基础会员全部权益',
              'AI材料生成（6类官方文档）',
          ...
          },
          {
            ...
            priceMonthly: 69990,
            priceYearly: 699900,
            priceMonthlyYuan: '699.90',
            priceYearlyYuan: '6,999',
            savingsPercent: 20,
            features: [
              '专业会员全部权益',
              'AI创业孵化 · 香港资源对接',
